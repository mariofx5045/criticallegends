...
if game.PlaceId == 8619263259 then
    ...
    local loopCount = 0
    local serverStartTime = tick() -- Store the server start time
    ...
    RunService.Heartbeat:Connect(function()
        local serverUptime = tick() - serverStartTime -- Calculate server uptime
        timerLabel.Text = "Time: " .. formatTime(serverUptime)
